...
<div class="row g-3 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="alamat_kirim" id="alamat_kirim" rows="2" class="form-control @error('alamat_kirim') is-invalid @enderror">{{ old('alamat_kirim', $order->alamat_kirim) }}</textarea>
                    @error('alamat_kirim')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
